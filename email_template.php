            ...
            <tr>
                <td align="center">
                    <table align="center" border="0" cellpadding="0"
                        ...
                        <tbody>
                            <tr>
                                <td align="center" style="background-color: #005697;
                                           height: 50px;">
            ...
            <tr style="display: inline-block;">
                <td style="height: 150px;
                    ...
                    <h2 style="text-align: left;
                               align-items: center;">
                       Your first step of registration is completed.
                       Please note the login id for the future .
                     <p>  Your user id:<b>userid</p>
                   </h2>
                    <p class="data"
                       style="text-align: justify-all;
                              ...
                              font-size: 15px;
                              padding-bottom: 12px;">
                       Please do the payment for booking your seats.
                    </p>
                    <p>
                        <a href=
